...
\caption{(\#tab:ResponseOutputg3)Regression of natural gas consumption on heating degree days, interacted with HOLC grade, ethnicity, and income, conditional on thermostat setpoint\label{tab:gasresponsethemset3}}
\centering
\resizebox{\linewidth}{!}{
